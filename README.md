...
- **Android 10+**：`/sdcard/Android/data/com.example.floatingscreenshot/files/Pictures/`
- **Android 9-**：`/sdcard/Pictures/Screenshots/`
...
#### Q: 找不到截屏图片？
A: 截屏保存在应用的图片文件夹中。可以使用文件管理器查看，或在截屏成功时查看 Toast 提示的完整路径。
